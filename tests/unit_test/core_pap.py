...
class TestCorePAP(unittest.TestCase):
    ...
    def test_objects(self):
        ...
        objects = self.pap.get_oubjects(self.ext_uuid, "user1")
        self.assertIsInstance(objects, list)
    ...
    def test_meta_rules(self):
        meta_rules = self.pap.get_meta_rules(self.ext_uuid, "user1")
        ...
        self.pap.add_meta_rules(self.ext_uuid, "user1", rule)

    def test_meta_rules_user_error(self):
        meta_rules = self.pap.get_meta_rules(self.ext_uuid, "user3")
