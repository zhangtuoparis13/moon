...
"""
from moon.core.pip import core
...
class PDP:
    ...
    def __init__(self, uuid="", tenant_name=None, policy_plugin_pointer=None, attributes=None):
        self.uuid = uuid
    ...
    def update_request_attributes(self, subject=None, action=None, object_name=None):
        ...
        """
        self.__attributes = core.update_request_attributes(subject,
                                                                action,
                                                                object_name,
                                                                self.tenant_name,
                                                                self.__attributes)
