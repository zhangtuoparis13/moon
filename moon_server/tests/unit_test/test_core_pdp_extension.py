...
from moon_server.tests.unit_test.samples.mls001.extension import results, requests
...
class TestCorePDPExtension(unittest.TestCase):
    ...
    def setUp(self):
        ...
        extension_setting_abs_dir = pkg_resources.resource_filename('moon_server', _sample_path)
    ...
    def test_add_del_rule(self):
        ...
        self.assertEqual(self.extension.add_rule(sub_cat_value, obj_cat_value)["relation_super"][0],
                         self._results["new_rules"])
